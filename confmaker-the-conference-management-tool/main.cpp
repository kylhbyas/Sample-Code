 ...
 * @author Kyle Byassee
 * @date 2022-03-16
 * @brief ConfMaker main function.
 * 
 * This program makes an Attendees object by reading in a fileName, parsing the file for data and printing an orgainized list of attendees.
 */
